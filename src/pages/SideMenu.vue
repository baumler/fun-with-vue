<template>
  <div class="menu" v-if="isLoaded">
    <h1 class="textCentered">This page uses <a href="https://github.com/eddiemf/vue-affix">vue-affix</a> and <a href="https://github.com/eddiemf/vue-scrollactive">vue-scrollactive</a></h1>
    <div class="flex">
